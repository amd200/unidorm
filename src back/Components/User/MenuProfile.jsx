    ...
    <div className='menu-profile bg-white rounded bg-white border'>
      <ul className='list-unstyled'>
        ...
        <li className={`nav-item   bg-white  `}>
          ...
          <ul className={`list-unstyled dropdown-list collapse ${isActive ? 'collapsed  show' : ''} `} id='submenu' >
            <li className='nav-item mb-2 bg-white'><NavLink to={"/user/addlisting"} className={"nav-link"}>Add Listing</NavLink></li>
          </ul>
        </li>
