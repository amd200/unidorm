      ...
      <div className="row">
        <div className="col-lg-8 border-end position-relative">
          ...
          <div className="description">
            ...
            <p>
              At The Landing, we know luxury is more than the sum of its parts
              it's about a seamless daily experience that finds you where you
              are and offers a multitude of possibilities right at your
              fingertips. A rooftop terrace for sunrise yoga. Co-working spaces
              to keep you inspired. A resident app that lets you order in, send
              laundry out, or get your car washed downstairs. Welcoming,
              inviting, a place to rest and recharge when the day is done, we'll
              greet you at the door and remind you why you've made this place
